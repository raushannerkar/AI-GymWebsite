...
intents_data = json.loads(open('C:\\Users\\RAUSHAN\\OneDrive\\Desktop\\Website_testing\\website_folder\\fitbot_module\\intents.json').read())
words_list = pickle.load(open('C:\\Users\\RAUSHAN\\OneDrive\\Desktop\\Website_testing\\website_folder\\fitbot_module\\words.pkl', 'rb'))
classes_list = pickle.load(open('C:\\Users\\RAUSHAN\\OneDrive\\Desktop\\Website_testing\\website_folder\\fitbot_module\\classes.pkl', 'rb'))
model = load_model('C:\\Users\\RAUSHAN\\OneDrive\\Desktop\\Website_testing\\website_folder\\fitbot_module\\chatbot_model.h5')
